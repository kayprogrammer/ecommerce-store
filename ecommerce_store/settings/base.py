...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "ECOMMERCE STORE ADMIN",
    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "E-STORE ADMIN",
    ...
    "welcome_sign": "Welcome to the Ecommerce Store Admin Section",
    ...
    "usermenu_links": [
        {"name": "E-Store FrontPage", "url": "/", "new_window": True},
        {"model": "accounts.user"},
    ],
    #############
    # Side Menu #
